...
app.use('/communitycoin/', Express.static(path.join(__dirname, '../../dist')));
app.use('/communitycoin/images', Express.static(path.join(__dirname, '../../images')));

const renderFullPage = (content, store) =>
  `<!doctype html>
    <html>
      <head>
        <link rel="stylesheet" type="text/css" href="/communitycoin/communitycoin.css" />
      ...
      <body>
        ...
        <script src="/communitycoin/communitycoin.js"></script>
      </body>
    </html>`;
